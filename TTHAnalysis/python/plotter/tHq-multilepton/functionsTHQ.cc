...
GetTHQBinning::GetTHQBinning(){
    TString fileName2l = "tHq-multilepton/signal_extraction/binning_2l.root";
...
GetTHQBinning THQClusteringSuite;
Int_t tHq_MVAto1D_2lss_sbratio(Double_t x, Double_t y){
    return THQClusteringSuite.GetCluster2l(x,y)+1;
}

Int_t tHq_MVAto1D_3l_sbratio(Double_t x, Double_t y){
    return THQClusteringSuite.GetCluster3l(x,y)+1;
}
